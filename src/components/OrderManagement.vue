    ...
    <el-card>
      ...
      >
        ...
        <el-table-column prop="customerInfo" label="客户信息" min-width="150">
          <template #default="{ row }">
            <div>
              ...
              <div style="color: var(--el-text-color-secondary); font-size: var(--el-font-size-small)">{{ row.customerEmail }}</div>
            </div>
          </template>
        </el-table-column>
        ...
        <el-table-column label="操作" width="200" fixed="right">
          <template #default="{ row }">
            <el-space>
              <el-button link class="action-btn" :icon="View" @click="handleViewDetail(row)">
                <span>查看</span>
              </el-button>
              <el-button link type="primary" class="action-btn" :icon="Edit" @click="handleEdit(row)">
                <span>编辑</span>
              </el-button>
              <el-popconfirm 
                title="确认删除该订单？" 
              ...
              >
                <template #reference>
                  <el-button link type="danger" class="action-btn" :icon="Delete">
                    <span>删除</span>
                  </el-button>
                </template>
              </el-popconfirm>
...
const handleBatchDelete = async () => {
  try {
    ...
    console.log('批量删除订单', selectedRows.value)
